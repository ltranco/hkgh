...
function moesia_custom_styles($custom) {
	...
	$custom .= ".footer-widget-area, .site-footer { background-color: #5bb82c; padding: 7px 3px 5px 3px;bottom:0;width:100%;font-size:17px;text-align:center;}"."\n";
	$custom .= "#footerLink:hover {color: #428bca !important;}"."\n";

	//Hack
	$custom .= ".custom-background {background-size: cover !important;}"."\n";
