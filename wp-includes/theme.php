...
function _custom_background_cb() {
	...
	if ( $background ) {
		$image = " background-image: url('$background') no-repeat center center fixed;-webkit-background-size: cover;-moz-background-size: cover;-o-background-size: cover;background-size: cover;";
